...
from utils import TopicType, Utils
import os
import openai
...
def process_categories(categories):
    blog_metadata = Utils.load_json("generated/blog_metadata.json")
    ...
    Utils.save_json(blog_metadata, os.path.join("generated/blog_metadata.json"))
    return blog_metadata


def writeBlogs():
    categories = Utils.load_json("user_input.json")
