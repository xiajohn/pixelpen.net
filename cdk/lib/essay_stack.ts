...
export class EssayStack extends cdk.Stack {
  ...
  private commonExcludeDirectories: string[] = ['video', 'video/*', 'common/video', 'common/video/*', 'generated', 'generated/*', 'blogPipeline', 'blogPipeline/*', '__pycache__', '__pycache__/*', 'test', 'test/*', 'user_input.json', 'run.py', '.gitignore', '.env'];
