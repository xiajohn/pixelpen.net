...
categories = {
    ...
    "honey": {
        "topics": [
            {"topic": "amber honey", "type": TopicType.TRANSACTIONAL},
            {"topic": "wingstop hot honey", "type": TopicType.TRANSACTIONAL},
            {"topic": "honey star", "type": TopicType.INFORMATIONAL},
            {"topic": "world honey bee day", "type": TopicType.INFORMATIONAL},
        ],
        "affiliate_links": [
    ...
    "soil": {
        "topics": [
            {"topic": "types of soil", "type": TopicType.TRANSACTIONAL},
            {"topic": "most fertile soil in the world", "type": TopicType.TRANSACTIONAL},
            {"topic": "websoilsurvey", "type": TopicType.TRANSACTIONAL},
            {"topic": "caliche", "type": TopicType.TRANSACTIONAL},
        ],
        "affiliate_links": [
    ...
    "summer": {
        "topics": [
            {"topic": "Best products summer 2023",
                "type": TopicType.TRANSACTIONAL},
            ...
            {"topic": "What Sunburn does to your skin",
                "type": TopicType.INFORMATIONAL},
        ],
        "affiliate_links": [
            {"name": "FURTALK Sun Visor Hats", "url": "https://amzn.to/3Lp8Bce"},
            {"name": "NPJY Bucket Hat for Women Men  ",
                "url": "https://amzn.to/3LHPdZr"},
            {"name": "Gildan A-Shirt Tanks", "url": "https://amzn.to/3nfAFGX"},
            {"name": "Neutrogena Beach Defense Water-Resistant",
                "url": "https://amzn.to/3LiLWyd"},
        ],
    },
    # "bbq": {
    #     "topics": [
